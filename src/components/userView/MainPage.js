  ...
  return (
    <>
      ...
      <div className="h-screen bg-clay-light grid grid-cols-12">
        {/* Sidebar */}
       <div className="col-span-2"><SideBar name={name} handleSignOut={handleSignOut} /></div> 

        {/* Main Content Area */}
        <div className="lg:col-span-10 md:col-span-9 sm:col-span-8 p-6 overflow-y-scroll">
