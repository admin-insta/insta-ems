        ...
        <div>
          {leaveRequests.map((request) => (
            ...
            >
              ...
              <div className="text-center text-sm">{request.leaveType}</div>
              <div className="text-center text-sm">
                {request.startDate} to {request.endDate} ({request.totalDays}{" "}
                days)
              </div>
              <div className="text-center text-sm">
                <p
              ...
              <div className="flex gap-2 justify-center">
                <Button onClick={() => handleApprove(request.applicationId)}>
                  Accept
                </Button>
                <Button
                  variant="secondary"
